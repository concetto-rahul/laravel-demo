...
<link rel="stylesheet" href="{{ asset('admin_theme/modules/owlcarousel2/owl.carousel.min.css')}}">
<link rel="stylesheet" href="{{ asset('admin_theme/modules/owlcarousel2/owl.theme.default.min.css')}}">
              ...
              <div class="card gradient-bottom">
                ...
                <div class="card-body" id="top-5-scroll">
                  <ul class="list-unstyled list-unstyled-border">
                    <li class="media">
                      <img class="mr-3 rounded" width="55" src="{{ asset('admin_theme/img/products/product-3-50.png') }}" alt="product">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded" width="55" src="{{ asset('admin_theme/img/products/product-4-50.png') }}" alt="product">
                      <div class="media-body">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded" width="55" src="{{ asset('admin_theme/img/products/product-1-50.png') }}" alt="product">
                      <div class="media-body">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded" width="55" src="{{ asset('admin_theme/img/products/product-5-50.png') }}" alt="product">
                      <div class="media-body">
                  ...
                  <div class="owl-carousel owl-theme" id="products-carousel">
                    <div>
                      <div class="product-item pb-3">
                        <div class="product-image">
                          <img alt="image" src="{{ asset('admin_theme/img/products/product-4-50.png') }}" class="img-fluid">
                        </div>
                    ...
                    <div>
                      <div class="product-item">
                        <div class="product-image">
                          <img alt="image" src="{{ asset('admin_theme/img/products/product-3-50.png') }}" class="img-fluid">
                        </div>
                        <div class="product-details">
                    ...
                    <div>
                      <div class="product-item">
                        <div class="product-image">
                          <img alt="image" src="{{ asset('admin_theme/img/products/product-1-50.png') }}" class="img-fluid">
                        </div>
                        <div class="product-details">
...
<script src="{{ asset('admin_theme/modules/owlcarousel2/owl.carousel.min.js')}}"></script>
@endsection
@section('page_script')
<script src="{{ asset('admin_theme/js/page/index.js')}}"></script>
@endsection